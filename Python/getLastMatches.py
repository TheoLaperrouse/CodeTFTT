...
if __name__ == '__main__':
    ...
    print(*(f"\033[1m{match['equipeA']}\033[0m  \033[91m{match['scoreA']}-{match['scoreB']}\033[0m  \033[1m{match['equipeB']}\033[0m" for match in last_matches if match is not None), sep="\n")